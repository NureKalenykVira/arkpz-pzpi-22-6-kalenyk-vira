...
--
-- Table structure for table `AnomalousDataLogs`
--

DROP TABLE IF EXISTS `AnomalousDataLogs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `AnomalousDataLogs` (
  ...
  CONSTRAINT `AnomalousDataLogs_ibfk_1` FOREIGN KEY (`sensor_id`) REFERENCES `Sensors` (`SensorID`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `AnomalousDataLogs`
--

LOCK TABLES `AnomalousDataLogs` WRITE;
/*!40000 ALTER TABLE `AnomalousDataLogs` DISABLE KEYS */;
INSERT INTO `AnomalousDataLogs` VALUES (1,3,'2024-12-23 06:55:25','Temperature','100','Too high'),(2,3,'2024-12-23 08:07:01','Temperature','140','Too high');
/*!40000 ALTER TABLE `AnomalousDataLogs` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `Notifications` VALUES (3,NULL,NULL,NULL,NULL,'2024-12-16 22:05:59'),(4,1,NULL,'Humidity is too high','New','2024-12-16 22:06:11'),(7,1,NULL,'Hello Alice, your product \"Apple\" is about to expire on Fri Dec 20 2024 00:00:00 GMT+0200 (за східноєвропейським стандартним часом). Please use it soon.','New','2024-12-19 04:58:44'),(8,2,NULL,'Hello Bob, your product \"Juice\" is about to expire on Fri Dec 20 2024 00:00:00 GMT+0200 (за східноєвропейським стандартним часом). Please use it soon.','New','2024-12-19 04:58:44'),(9,2,NULL,'Dear Bob, your product \"Expired Milk\" expired on Tue Dec 10 2024 00:00:00 GMT+0200 (за східноєвропейським стандартним часом). Please discard it.','New','2024-12-19 05:06:21'),(10,2,NULL,'Dear Bob, your product \"Expired Cheese\" expired on Wed Dec 11 2024 00:00:00 GMT+0200 (за східноєвропейським стандартним часом). Please discard it.','New','2024-12-19 05:06:21'),(11,1,16,'Проблеми з умовами зберігання: Температура перевищує норму. Вологість перевищує норму.','New','2024-12-19 06:14:37'),(12,1,17,'Проблеми з умовами зберігання: Температура перевищує норму. Вологість перевищує норму.','New','2024-12-19 06:14:46'),(13,1,NULL,'Сенсор 16 виявив проблеми:\n- Температура перевищує норму: 12.5°C.\n- Вологість перевищує норму: 85.3%.','New','2024-12-19 06:29:12'),(14,1,NULL,'Сенсор 17 виявив проблеми:\n- Температура перевищує норму: 15°C.\n- Вологість перевищує норму: 90%.','New','2024-12-19 06:29:12'),(15,2,NULL,'Сенсор 3 виявив проблеми:\n- Вологість перевищує норму: 80.2%.','New','2024-12-19 06:29:12'),(16,2,NULL,'Сенсор 14 виявив проблеми:\n- Температура перевищує норму: 20°C.\n- Вологість перевищує норму: 95%.','New','2024-12-19 06:29:12'),(17,2,NULL,'Сенсор 15 виявив проблеми:\n- Вологість перевищує норму: 90%.','New','2024-12-19 06:29:12'),(18,1,17,'Проблеми з умовами зберігання: Температура перевищує норму. Вологість перевищує норму.','New','2024-12-19 06:29:46'),(19,1,NULL,'Hello Alice, your product \"Chicken\" is about to expire on Sun Dec 22 2024 00:00:00 GMT+0200 (за східноєвропейським стандартним часом). Please use it soon.','New','2024-12-21 01:29:06'),(20,1,NULL,'Hello Alice, your product \"Carrot\" is about to expire on Wed Dec 25 2024 00:00:00 GMT+0200 (за східноєвропейським стандартним часом). Please use it soon.','New','2024-12-23 08:53:32'),(21,1,NULL,'Hello Alice, your product \"Carrot\" is about to expire on Wed Dec 25 2024 00:00:00 GMT+0200 (за східноєвропейським стандартним часом). Please use it soon.','New','2024-12-23 09:34:29'),(22,1,NULL,'Hello Alice, your product \"Carrot\" is about to expire on Wed Dec 25 2024 00:00:00 GMT+0200 (за східноєвропейським стандартним часом). Please use it soon.','New','2024-12-23 09:36:49'),(23,1,17,'Проблеми з умовами зберігання: Температура перевищує норму. Вологість перевищує норму.','New','2024-12-23 09:37:04'),(24,1,NULL,'Сенсор 16 виявив проблеми:\n- Температура перевищує норму: 12.5°C.\n- Вологість перевищує норму: 85.3%.','New','2024-12-23 09:37:12'),(25,1,NULL,'Сенсор 17 виявив проблеми:\n- Температура перевищує норму: 15°C.\n- Вологість перевищує норму: 90%.','New','2024-12-23 09:37:12'),(26,2,NULL,'Сенсор 3 виявив проблеми:\n- Вологість перевищує норму: 80.2%.','New','2024-12-23 09:37:12'),(27,2,NULL,'Сенсор 14 виявив проблеми:\n- Температура перевищує норму: 20°C.\n- Вологість перевищує норму: 95%.','New','2024-12-23 09:37:12'),(28,2,NULL,'Сенсор 15 виявив проблеми:\n- Вологість перевищує норму: 90%.','New','2024-12-23 09:37:12'),(29,1,NULL,'Hello Alice, your product \"Carrot\" is about to expire on Wed Dec 25 2024 00:00:00 GMT+0200 (за східноєвропейським стандартним часом). Please use it soon.','New','2024-12-23 09:38:10'),(30,1,17,'Проблеми з умовами зберігання: Температура перевищує норму. Вологість перевищує норму.','New','2024-12-23 09:38:28'),(31,1,NULL,'Сенсор 16 виявив проблеми:\n- Температура перевищує норму: 12.5°C.\n- Вологість перевищує норму: 85.3%.','New','2024-12-23 09:38:46'),(32,1,NULL,'Сенсор 17 виявив проблеми:\n- Температура перевищує норму: 15°C.\n- Вологість перевищує норму: 90%.','New','2024-12-23 09:38:46'),(33,2,NULL,'Сенсор 3 виявив проблеми:\n- Вологість перевищує норму: 80.2%.','New','2024-12-23 09:38:46'),(34,2,NULL,'Сенсор 14 виявив проблеми:\n- Температура перевищує норму: 20°C.\n- Вологість перевищує норму: 95%.','New','2024-12-23 09:38:46'),(35,2,NULL,'Сенсор 15 виявив проблеми:\n- Вологість перевищує норму: 90%.','New','2024-12-23 09:38:46');
...
CREATE TABLE `SensorHistory` (
  ...
  PRIMARY KEY (`id`),
  KEY `sensor_id` (`sensor_id`),
  CONSTRAINT `SensorHistory_ibfk_1` FOREIGN KEY (`sensor_id`) REFERENCES `Sensors` (`SensorID`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `SensorHistory` VALUES (2,3,'2024-12-23 06:51:49','Status','Active','Inactive','Admin');
...
INSERT INTO `SensorThresholds` VALUES (1,'Temperature',-15,40),(2,'Humidity',10,90),(3,'Pressure',900,1100);
...
INSERT INTO `SystemConfigurations` VALUES (1,'SecurityPolicy','false','2024-12-23 09:41:10'),(2,'IntegrationEnabled','false','2024-12-22 17:01:47'),(3,'MaxLoginAttempts','5','2024-12-22 17:01:47');
...
-- Dump completed on 2024-12-23  9:46:13
